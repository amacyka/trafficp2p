...
class Settings(BaseSettings):
    ...
    # xRocket uses a hyphen in symbol names, e.g. "GRAM-USDT", "BTC-USDT".
    # Verified live against /api/v1/symbols on 2026-09-20 — there is no
    # TON-USDT pair on this exchange; GRAM-USDT is the closest TON-related,
    # actively traded, "featured" pair.
    symbol: str = "GRAM-USDT"
